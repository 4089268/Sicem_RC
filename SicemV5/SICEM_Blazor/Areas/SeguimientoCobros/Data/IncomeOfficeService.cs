...
namespace SICEM_Blazor.SeguimientoCobros.Data
{
    public class IncomeOfficeService
    {
        ...
        /// <returns></returns>
        public ICollection<IngresoHorario> IngresosPorHorario(IEnlace enlace, Sicem_Sucursal sucursal, DateTime fecha)
        {
            try
            {
                ...
                using(var conexion = new SqlConnection(enlace.GetConnectionString()))
                {
                    ...
                    command.Parameters.AddWithValue("@dia", fecha.ToString("yyyyMMdd"));
